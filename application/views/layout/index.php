...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/jqvmap-novulnerability/dist/jqvmap.min.css">
  <!-- Theme style -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/summernote/dist/summernote-bs4.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/select2-theme-bootstrap4/dist/select2-bootstrap.min.css">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-light">Registrasi</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="text-transform: capitalize"><?php echo $this->session->userdata('username'); ?>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url() ?>assets/vendor/jquery-ui-dist/jquery-ui.min.js"></script>
...
<!-- JQVMap -->
<script src="<?php echo base_url() ?>assets/vendor/jqvmap-novulnerability/dist/jquery.vmap.min.js"></script>
<script src="<?php echo base_url() ?>assets/vendor/jqvmap-novulnerability/dist/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url() ?>assets/vendor/jquery-knob-chif/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?php echo base_url() ?>assets/vendor/moment/min/moment.min.js"></script>
<script src="<?php echo base_url() ?>assets/vendor/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="<?php echo base_url() ?>assets/vendor/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
